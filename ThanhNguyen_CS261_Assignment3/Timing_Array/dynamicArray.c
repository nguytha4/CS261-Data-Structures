...
TYPE getDynArr(DynArr *v, int pos)
{
	...
	/* Return data stored at given position */
	return v->data[pos];
}
...
void swapDynArr(DynArr *v, int i, int  j)
{
	...
	/* Store the value originally at position i in a temp variable */
	temp = v->data[i];

	/* Make element i equal to the value at position j */
	v->data[i] = v->data[j];

	/* Make element j equal to temp (i.e., the value originally at position i */
	v->data[j] = temp;
}
